class World {
    ...
    constructor(player, width, height) {
        ...
        this.vehicles = [
            new Vehicle(300, 500, 200, 160, 0, Colors.YELLOW, 500, Math.PI / 8),
            new Vehicle(500, 500, 200, 160, 0, Colors.GREEN, 200, Math.PI / 8),
            new Vehicle(600, 600, 200, 160, 0, Colors.RED, 400, Math.PI / 8),
